...
<div class="section-1" id="feature">
    ...
    <div class="container bg-dark">
        <h3 style="color:white;">In the below section,a slide show is ready to start C++ Programming</h3>
    </div>
...
<div class="sliderText">
 <img src="img/download.png" alt="Image3" class="card-img-top" style="height:200px;">
...
C++ is a general-purpose, procedural computer programming language supporting structured programming, lexical variable scope, and recursion.
  ...
  <div class="swiper-slide">
   ...
   <img src="img/uva.png" class="card-img-top" style="height:260px;">
    
    </div>
    <div class="content">
    
    <h5>
    For learning C++,you have to solve problem online judge.
     .
    </h5>
    ...
    <div class="container" style="margin-top:20px;">
            ...
            <div class="col-md-4">
                <div class="card " style="height:350px;">
                    ...
                    <div class="card-body bg-dark">
                        <ol id="videos">
                            <li><a id="island" href="https://www.youtube.com/watch?v=0T4mPpbNs_8&list=PLgH5QX0i9K3q0ZKeXtF--CZ0PdH1sSbYL">Tutorial 1</a></li>
                             <li><a id="timeLapse" href="https://www.youtube.com/watch?v=e6xYGbYst7M">Tutorial 2</a></li>
                             <li><a id="darkside" href="https://www.youtube.com/watch?v=MPAwC5fz6UQ">Tutorial 3</a></li>
       ...
       <iframe  src="https://www.youtube.com/embed/YCXeHzDtigA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card" style="height:350px;">
                     <img src="img/uri.jpg" alt="img4" class="card-img-top" style="height:350px;">
                </div>
            </div>
            <div class="col-md-4">
                <div class="card" style="height:350px;">
                   <img src="img/code.png" alt="img4" class="card-img-top" style="height:350px;">
...
<div class="section-4 bg-dark">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <a href="#">Join Us</a>
                <p class="para-1">
                    It is a <strong>C++ programming<strong> platform.Here we learn about <strong>Python</strong> and how to start in C++ programming and the fields of C++.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container text-center ">
        ...
        <h1>Our C++ programmer Team Members</h1>
...
<div class="container">
    ...
    <img src="img/pic1.jpg" alt="Image3" class="card-img-top"  style="width:150px;height:70px;border-radius:50%;margin-left:40px;">
                      <div class="card-body text-center">
                          ...
                          <h3 class="card-title">C++ Programmer</h3>
                               <p class="card-text" style="font-family:'Ubuntu';margin-left:65px;">C is a low level language..</p>
                      </div> 
                 ...
                 <div class="card2 text-center" >
                  <img src="img/pic2.jpg" alt="Image3" class="card-img-top"  style="width:150px;height:70px;border-radius:50%;margin-left:40px;">
                      <div class="card-body text-center">
                          ...
                          <h3 class="card-title">C++ Programmer</h3>
              <p class="card-text" style="font-family:'Ubuntu';margin-left:65px;">C is my favourite Language</p>
                      </div>   
                  <div style="font-weight:bold;">
